...
1. Игровое меню
    ...
    * кнопка **Настройки** - открывает новое окно с настройками:
        ...
        * кнопка "Сохранить" сохраняет настройки и выходит в предылущее меню
...
* Добавление случайных препятствий на карту (для однопользовательского и многопользовательского режима)
